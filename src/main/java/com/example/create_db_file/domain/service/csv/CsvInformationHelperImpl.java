...
@Component
public class CsvInformationHelperImpl implements CsvInformationHelper {
     ...
     */
    @Override
    public Map<Integer, String> analyzeCsvHeader(InputStream in){
    ...
    @Override
    public void saveCsvFile(InputStream in, String newFilePath){
